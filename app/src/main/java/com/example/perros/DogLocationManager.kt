...
class DogLocationManager(
    ...
    fun guardarZonaSegura(perroId: String) {
        if (zonaSeguraCircle == null) {
            Toast.makeText(context, "Define la zona segura antes de guardar", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        database.child("users").child(perroId).child("zonaSegura")
            ...
            .addOnFailureListener { e ->
                ...
                Toast.makeText(context, "Error al guardar zona segura", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun comprobarYNotificarZonaInsegura() {
        if (zonaSeguraCircle == null || 
            zonaCentroLat == null || zonaCentroLng == null || zonaRadio == 0.0 ||
            ultimaPosLat == null || ultimaPosLng == null ||
            modoEdicionZonaSegura) // No verificar cuando estamos en modo edición
            return
    ...
    private fun enviarNotificacionZonaInsegura() {
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setContentText("¡$perroNombre ha salido de la zona segura!")
    ...
    fun centrarMapaEnZonaSegura(perroId: String) {
        ...
        if (snapshot != null && snapshot.exists()) {
            ...
            if (lat != null && lng != null) {
                ...
                Toast.makeText(context, "No hay zona segura definida correctamente", Toast.LENGTH_SHORT).show()
            }
        } else {
